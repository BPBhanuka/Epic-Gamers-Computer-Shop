        ...
        <div class="row gy-4">
            ...
            <!-- <div class="col-12 justify-content-center">
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="offset-3 offset-lg-2 col-12 col-lg-6">

                        <div class="input-group mt-3 mb-3">
                            <input type="text" class="form-control bg-warning" placeholder="Search in Products..." aria-label="Text input with dropdown button" id="basic_search_txt"
            ...
            <div class="col-12">
                <div class="row"> 
                    <div class="col-lg-2 d-grid d-lg-block"> 
                        <button class="c3" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" 
                        aria-controls="offcanvasExample">Category</button>
