                ...
                <div class=" mt-3 col-12 col-lg-4  ">
                    <div class="row">
                        ...
                        <div class="col-md-2 mt-4" >
                            ...
                            <div class="card d8 popup" style="width: 300px; border-width: 5px; border-color:#505050; border-radius: 20px;" >
                            ...
                            ?>
                                ...
                                <img src= "<?php echo $image_data["code"]; ?>" class="card-img-top" style="height: 240px;"/>
                                        
                                <div class="card-body">
                                    <h5 class="card-title fs-6 fw-bold text-dark"><?php echo $selected_data["title"]; ?> <span class="badge bg-warning">New</span></h5>
                                    ...
                                    if ($watchlist_num == 1) {
                                    ?>
                                        <button class="col-12 btn btn-dark mt-2 border border-info" 
                                    ...
                                    ?>
                                        <button class="col-12 btn btn-dark mt-2 border border-info" 
                                            onclick='addToWatchlist(<?php echo $selected_data["id"]; ?>);'>
                                            <i class="bi bi-heart-fill text-info fs-5" id='heart<?php echo $selected_data["id"]; ?>'></i>
                                        </button>
                                    <?php
                                    }
                    ...
                    <ul class="pagination pagination-lg justify-content-center">
                        ...
                        ?>
                                <li class="page-item active">
                                    <a class="page-link bg-warning" onclick="basicSearch(<?php echo ($x) ?>);"><?php echo $x; ?></a>
                                </li>
                            <?php
                            } else {
                            ?>
