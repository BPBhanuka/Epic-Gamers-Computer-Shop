...
<head>
    ...
    <title>Admin Product SignIn | Epic Gamers Computer</title>
        ...
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="text-center title6">Hi, Welcome to Epic Gamers Computer Admins.</p>
                    </div>
                    ...
                    <div class="offset-4 offset-lg-3 col-12 col-lg-6 d-block border border-2 rounded bg-gradient">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-6 d-grid mt-2 mb-4">
                                <button class="btn btn-primary" onclick="adminProductVerificationCode();">Send Verification Code</button>
                            </div>
                            <div class="col-12 col-lg-6 d-grid mt-2 mb-4">
            ...
            <div class="col-12 d-none d-lg-block bm-5 b1 mt-2">
                <p class="text-center">&copy; 2023 egcomputer.lk || All Rights Reserved</p>
            </div>
            <!-- footer -->
