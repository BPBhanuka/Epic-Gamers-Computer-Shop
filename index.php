...
<head>
    ...
    <title>Epic Gamers Computer</title>
        ...
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="text-center title1">Epic Gamers Computer</p>
                    </div>
                </div>
            </div>
            <!-- header -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6" id="signUpBox">
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="signUpbutton" onclick="signUp();">Register Now</button>
                            </div>
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="changeButton" onclick="changeView();">Already have an account?Sign In</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6 d-none" id="signInBox">
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="changeButton" onclick="changeView();">Now to EGcomputer?Join Now</button>
                            </div>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content bg-info">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="password" class="form-control bg-warning" id="npi"/>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="password" class="form-control bg-warning" id="rnp"/>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control bg-warning" id="vc"/>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="resetButton" onclick="resetpw();">Reset Password</button>
                        </div>
                    </div>
                </div>
            </div>
