...
<head>
    ...
    <title>Cart | Epic Gamers Computer</title>
                ...
                <div class="col-12 border border-1 border-primary rounded mb-3">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="offset-lg-2 col-12 col-lg-6 mb-3">
                                    <input type="text" class="form-control d11" placeholder="Search in Cart..." 
                        ...
                        ?>
                            ...
                            <div class="col-12 col-lg-9">
                                <div class="row">
                                    ...
                                    for ($x = 0; $x < $cart_num; $x++) {
                                        ...
                                        if ($address_data == 2) {
                                            $ship = $product_data["delivery_fee_gampaha"];
                                        ...
                                        $user = $user_data["fname"] . " " . $user_data["lname"];

                                    ?>

                                        <div class="card mb-3 mx-0 col-12 d9 ">
                                            <div class="row g-0">
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <span class="fw-bold text-black-50 fs-5">Buyer :</span>&nbsp;
                                                            <span class="fw-bold text-black fs-5"><?php echo $user; ?></span>&nbsp;
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <span class="d-inline-block " tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="<?php echo $product_data["description"]; ?> " title="Product Details ">
                                                        ...
                                                        <img src="<?php echo $image_data["code"]; ?>" class="img-fluid rounded-start" style="max-width: 300px;">
                                                    </span>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        ?>
                                                        <span class="fs-5 fw-bold text-warning">Colour : </span>&nbsp;&nbsp;
                                                        <span class="fw-bold text-black fs-5"><?php echo $clr_data["name"]; ?></span>
                                                        <br />

                                                        <span class="fw-bold text-warning fs-5">Price :</span>&nbsp;
                                                        <span class="fw-bold text-black fs-5"><?php echo $product_data["price"]; ?></span>
                                                        <br>
                                                        <span class="fw-bold text-warning fs-5">Quantity :</span>&nbsp;
                                                        <span class="fw-bold text-black fs-5"><?php echo $product_data["qty"]; ?></span>&nbsp;
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card-body d-grid">
                                                        ...
                                                        if ($watchlist_num == 1) {
                                                        ?>
                                                            <button class="col-12 btn btn-outline-warning mb-2" onclick='addToWatchlist(<?php echo $product_data["id"]; ?>);'>
                                                ...
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 col-md-6 text-end">
                                                            <span class="fw-bold fs-5 text-black">Rs.
                            ...
                            <!-- summary -->
                            <div class="offset-lg-0 col-12 col-lg-3 bg-secondary" style="border-radius:10px; height: 460px;">
                                <div class="row">
                                    ...
                                    <div class="col-6 mt-2 text-end">
                                        <span class="fs-4 fw-bold text-white">Rs. <?php echo $total ?>.00</span>
                                    </div>

                                    <div class="col-12 mt-5 mb-3 d-grid">
                                        <button class="checkoutButoon col-12 fs-5 fw-bold" onclick="checkout( <?php echo $total ?> );">CHECKOUT</button>
                                    </div>
