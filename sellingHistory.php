...
<head>
    ...
    <title>Selling History | Admins | EPIC Gamers Computer</title>
...
<body class="d4">
    ...
    <div class="container-fluid">
        <div class="row"> 
            ...
            <div class="col-12 bg-light text-center mx-auto ">
                <label class="form-label text-primary fw-bold fs-1">Selling History</label>  
            </div>

            <div class="col-12 bg-info mt-3 mb-3">
                <div class="row">
                    <div class="col-12 col-lg-2 mt-3 mb-3">
                        <label class="form-label fs-5">Search by Invoice ID : </label>
                        <input type="text" class="form-control fs-5 bg-warning" id="searchtxt" placeholder="search Id..." onkeyup="searchInvoiceId();" />
                    </div>
                    <div class="col-12 col-lg-2 mt-3 mb-3"></div>
                    <div class="col-12 col-lg-2 mt-3 mb-3">
                        <label class="form-label fs-5 ">From Date : </label>
                        <input type="date" class="form-control fs-5 bg-warning" id="from"/>
                    </div>
                    <div class="col-12 col-lg-2 mt-3 mb-3">
                        <label class="form-label fs-5">To Date : </label>
                        <input type="date" class="form-control fs-5 bg-warning" id="to"/>
                    </div>
                    <div class="col-12 col-lg-1 mt-4 mb-3 d-grid mx-5">
                        <button class="findButton fs-5 fw-bold " onclick="findSellings();">Find</button>
                    </div>
                    <div class="col-12 col-lg-1 mt-4 mb-3 d-grid mx-5">
                        <button class="clearButton2 fs-5 fw-bold " onclick="clearsort();">Clear All</button>
                    </div>
                </div>
            </div>
