...
?>
    ...
    <head>
        ...
        <title>Products Update & Add  | EPIC Gamers Computer</title>
        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                <div class="col-12 col-lg-8 mt-2 my-lg-4">
                                    <h1 class="offset-4 offset-lg-2 text-white fw-bold fs-3">Update Products & Add Products</h1>
                                </div>  
                                <div class="col-12 col-lg-2 mx-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                    <button class="btn btn-warning fw-bold" onclick="window.location='adminPanel.php'">Dashboard</button>
                ...
                <div class="col-12">
                    <div class="row">
                        <!-- filter -->
                        <div class="col-12 col-lg-2 mx-3 my-3 border border-primary rounded bg-secondary">
                            <div class="row">
                                <div class="col-12 mt-3 fs-5">
                                    <div class="row">

                                        <div class="col-12">
                                            <label class="form-label fw-bold fs-3 text-warning">Sort Products</label>
                                        </div>
                                        <!-- <div class="col-11">
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" placeholder="Search..." class="form-control bg-info" id="s"/>
                                                </div>
                                                <div class="col-1 p-1">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold text-info">Active Time</label>
                                        </div>
                                        <div class="col-12">
                                            <hr style="width: 80%;" />
                                        </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            <label class="form-label fw-bold text-info">By quantity</label>
                                        </div>
                                        <div class="col-12">
                                            <hr style="width: 80%;" />
                                        </div>
                                        ...
                                        <div class="col-12 text-center mt-3 mb-3">
                                            <div class="row g-2">
                                                <div class="col-12 col-lg-6 d-grid">
                                                    <button class="sortButton fw-bold" onclick="sort1(0);">Sort</button>
                                                </div>
                                                <div class="col-12 col-lg-6 d-grid">
                                                    <button class="clearButton3 fw-bold" onclick="clearsort();">Clear</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="offset-1 col-10 text-center">
                                    ...
                                    LIMIT " . $results_per_page . " OFFSET " . $page_results . "");
                                        ...
                                        ?>
                                            ...
                                            <!-- card -->
                                            <div class="card mb-3 mt-3 col-12 col-lg-5 mx-4 border-secondary y2 popup" style="border-radius: 20px; border-width: 4px;">
                                                <div class="row"> 
                                                <div class="col-md-4 mt-4">
                                                        ...
                                                        ?>
                                                        <img src="<?php echo $product_img_data["code"]; ?>" class="img-fluid rounded-start mb-4" />
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                            <h5 class="card-title fw-bold text-dark"><?php echo $selected_data["title"]; ?></h5>
                                                            <span class="card-text fw-bold text-white">Rs. <?php echo $selected_data["price"]; ?> .00</span><br />
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="row g-1">
                                                                        <div class="col-12 col-lg-6 d-grid mt-2">
                                                                            <a href="updateProduct.php" class="btn btn-danger fw-bold" onclick="sendId(<?php echo $selected_data['id']; ?>);">Update</a>
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mb-3">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination pagination-lg justify-content-center">
                                            <li class="page-item">
                                                <a class="page-link bg-warning" href="<?php if ($pageno <= 1) {
                                                                                echo "#";
                                                                            } else {
                                                                                 echo "?page=" . ($pageno - 1);
                                                                            } ?>" aria-label="Previous">
                                            ...
                                            <li class="page-item">
                                                <a class="page-link bg-warning" href="<?php if ($pageno >= $number_of_pages) {
                                                                                echo "#";
                                                                            } else {
                                                                                echo "?page=" . ($pageno + 1);
                                                                            } ?>" aria-label="Next">
